        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 mt-[24px] gap-[8px]">
          {accountTypes.map(({Icon, name}: any, indx) => {
            return (
              ...
              key={indx}
                className={`relative flex flex-col items-center cursor-pointer ${selectedAccount === name  ? ' bg-[#F7FFF8]': ' bg-[#FFFFFF]'}  border border-[#EEEEEE] w-[152px] lg:w-[182.5px] min-h-[113px] rounded-md  `}
              >
